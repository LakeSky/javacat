...
public class DesUtil {
    ...
    public static byte[] encrypt(byte[] arrB, String password) {
        try{
            SecureRandom random = new SecureRandom();
            DESKeySpec desKey = new DESKeySpec(password.getBytes());
    ...
    public static String encrypt(String strIn, String password) {
        try {
            return byteArr2HexStr(encrypt(strIn.getBytes("UTF-8"), password));
     ...
     * @throws Exception
     */
    public static String encrypt(String strIn, String password,String charSet) {
        try {
            return byteArr2HexStr(encrypt(strIn.getBytes(charSet), password));
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();  //To change body of catch statement use File | Settings | File Templates.
        }
        return null;
