...
public class XmlUtils {
    ...
    public static Document getDocument(String xml) {
        ...
        try {
            ...
            logger.error("parser xml error!xml:[" + xml + "]");
        }
        return document;
    }
     ...
     * @throws DocumentException
     */
    public static Document getDocumentByPath(String xmlPath) {
        if (xmlPath == null || xmlPath.equals(""))
            return null;
     ...
     */
    @SuppressWarnings("rawtypes")
    public static void parserAllElementToMap(Element element, Map<String, String> result) {
        if (element == null) {
            return;
        }
        ...
        if (elements.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                // 递归遍历
                parserAllElementToMap(elem, result);
            }
        }
    }
}